...
export default function AdminOperationsCenter() {
  ...
  const criticalVulns = metrics?.criticalVulns ?? 0;
  const findingTone = criticalVulns > 0 ? "var(--crit)" : "var(--warn)";
  const findingSubMain = criticalVulns > 0 ? `${criticalVulns} CRITICAL` : "0 CRITICAL";
      ...
      <main className="ops-main">
        ...
        <section className="ops-content">
          <div className="kpi-row">
            ...
            <Kpi label="Findings Detected" value={String(metrics?.vulnsDetected ?? 0)} subMain={findingSubMain} subText="from processed jobs" color={findingTone} />
