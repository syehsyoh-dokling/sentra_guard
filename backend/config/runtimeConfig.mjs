...
export const runtimeConfig = {
  ...
  midtransBaseUrl: process.env.MIDTRANS_BASE_URL || "https://api.sandbox.midtrans.com",
  midtransServerKey: cleanSecret(process.env.MIDTRANS_SERVER_KEY),
  midtransClientKey: cleanSecret(process.env.MIDTRANS_CLIENT_KEY),
  sumsubBaseUrl: process.env.SUMSUB_BASE_URL || "https://api.sumsub.com",
  sumsubAppToken: cleanSecret(process.env.SUMSUB_APP_TOKEN),
  sumsubSecretKey: cleanSecret(process.env.SUMSUB_SECRET_KEY),
  resendBaseUrl: process.env.RESEND_BASE_URL || "https://api.resend.com",
  resendApiKey: cleanSecret(process.env.RESEND_API_KEY),
  resendFromEmail: process.env.RESEND_FROM_EMAIL || "",
  whatsappGraphBaseUrl: process.env.META_GRAPH_BASE_URL || "https://graph.facebook.com",
  whatsappAccessToken: cleanSecret(process.env.WHATSAPP_ACCESS_TOKEN),
  whatsappPhoneNumberId: process.env.WHATSAPP_PHONE_NUMBER_ID || "",
  whatsappBusinessAccountId: process.env.WHATSAPP_BUSINESS_ACCOUNT_ID || "",
  whatsappWebhookVerifyToken: cleanSecret(process.env.WHATSAPP_WEBHOOK_VERIFY_TOKEN),
...
const editableKeyMap = {
  ...
  sumsubAppToken: "sumsubAppToken",
  sumsubSecretKey: "sumsubSecretKey",
  resendBaseUrl: "resendBaseUrl",
  resendApiKey: "resendApiKey",
  resendFromEmail: "resendFromEmail",
  whatsappGraphBaseUrl: "whatsappGraphBaseUrl",
...
export function getEditableRuntimeConfig() {
  return {
    ...
    midtransBaseUrl: runtimeConfig.midtransBaseUrl,
    midtransServerKey: maskSecretValue(runtimeConfig.midtransServerKey),
    midtransClientKey: maskSecretValue(runtimeConfig.midtransClientKey),
    sumsubBaseUrl: runtimeConfig.sumsubBaseUrl,
    sumsubAppToken: maskSecretValue(runtimeConfig.sumsubAppToken),
    sumsubSecretKey: maskSecretValue(runtimeConfig.sumsubSecretKey),
    resendBaseUrl: runtimeConfig.resendBaseUrl,
    resendApiKey: maskSecretValue(runtimeConfig.resendApiKey),
    resendFromEmail: runtimeConfig.resendFromEmail,
    whatsappGraphBaseUrl: runtimeConfig.whatsappGraphBaseUrl,
    whatsappAccessToken: maskSecretValue(runtimeConfig.whatsappAccessToken),
    whatsappPhoneNumberId: runtimeConfig.whatsappPhoneNumberId,
    whatsappBusinessAccountId: runtimeConfig.whatsappBusinessAccountId,
    whatsappWebhookVerifyToken: maskSecretValue(runtimeConfig.whatsappWebhookVerifyToken),
    ...
    storageEndpointUrl: runtimeConfig.storageEndpointUrl,
...
export function getSafeRuntimeConfig() {
  return {
    ...
    secretsConfigured: {
      ...
      midtransServerKey: Boolean(runtimeConfig.midtransServerKey),
      midtransClientKey: Boolean(runtimeConfig.midtransClientKey),
      sumsubAppToken: Boolean(runtimeConfig.sumsubAppToken),
      sumsubSecretKey: Boolean(runtimeConfig.sumsubSecretKey),
      resendApiKey: Boolean(runtimeConfig.resendApiKey),
      whatsappAccessToken: Boolean(runtimeConfig.whatsappAccessToken),
      whatsappWebhookVerifyToken: Boolean(runtimeConfig.whatsappWebhookVerifyToken),
